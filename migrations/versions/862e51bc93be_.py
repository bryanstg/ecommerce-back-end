...
Revision ID: 862e51bc93be
Revises: 
Create Date: 2021-06-23 00:39:55.851860
...
def upgrade():
    ...
    sa.Column('cellphone_number', sa.String(length=30), nullable=False),
    ...
    op.create_table('product_to_buy',
    sa.Column('id', sa.Integer(), nullable=False),
